...
public class Board {
    ...
    public State stepGame(Seed player, int selectedRow, int selectedCol) {
        ...
        if (cells[selectedRow][0].content == player  // 3-in-the-row
            ...
            if(player == Seed.CROSS) winningPlayer = "Maxwell";
            else winningPlayer = "Oiia Cat";
            int option = JOptionPane.showOptionDialog(null, winningPlayer + " Wins", "Do you want to play again?", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, choice, choice[0]);
            if(option == 0) newGame();
            else System.exit(0);
            ...
            SoundEffect.BUMP.play();
            Object[] choice = {"Play Again", "Exit"};
            int option = JOptionPane.showOptionDialog(null, "Draw", "Do you want to play again?", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, choice, choice[0]);
            if(option == 0) newGame();
            else System.exit(0);
